      ...
      bulletPoints={[
        {
          ...
          description: "Three generations of expertise in luxury roofing.",
        },
        {
          title: "Transparent Pricing",
          description: "Clear, honest communication with no hidden costs.",
        },
        {
          title: "Storm Experts",
      ...
      features={[
        {
          ...
          description: "High-end replacement and repair.",
          bentoComponent: {
        ...
        },
        {
          ...
          description: "Premium durability and curb appeal.",
          bentoComponent: {
            bentoComponent: "reveal-icon",
            icon: SquareStack,
          },
        ...
        },
        {
          ...
          description: "Rapid emergency storm repair.",
          bentoComponent: {
            bentoComponent: "reveal-icon",
            icon: CloudLightning,
          },
      ...
      faqs={[
        {
          ...
          content: "We proudly serve luxury homes across New Jersey and New York.",
        },
        {
          id: "f2",
          title: "How fast do you respond to storm damage?",
          content: "We offer a 24-hour response guarantee for all storm damage requests.",
        },
        {
          id: "f3",
          title: "Do you offer financing?",
          content: "Yes, we work with homeowners to provide transparent pricing and flexible options.",
        },
      ]}
